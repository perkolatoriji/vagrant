...
##########################################################################
#
#  Program: prometheus_config.sh
#
#  Description:
#
#    Shell Script to configure a prometheus server.
#
# Versions       Date         Programmer, Modification
# -----------    ----------   -------------------------------------------
# Version=1.00   17/11/2020 - Carlos Ijalba, Original.
  Version=1.01 # 17/11/2020 - Carlos Ijalba, Latest updates.
#
#########################################################################
#set -x
